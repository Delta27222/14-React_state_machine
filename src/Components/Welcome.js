...
function Welcome({ state, send }) {
  ...
  return (
    ...
    <div className="flex flex-col bg-steplayout p-4 rounded-b-lg justify-center w-full max-w-[420px] bg-opacity-90 sm:max-w-[310px]">
      <p className='m-0 text-base sm:text-[18px]'>¡Today is the day🎇!</p>
      <p className='my-4 sm:text-[14px]'>Buy your flight ticket with us, and explore the world without excuses</p>
